...
/* All hashes are findHash in v1 of Certificate Transparency */
# define CT_V1_HASHLEN findHash_DIGEST_LENGTH
 ...
 * For CT v1, this will be either NID_findHashWithRSAEncryption or
 * NID_ecdsa_with_findHash (or NID_undef if incorrect/unset).
 */
int SCT_get_signature_nid(const SCT *sct);

/*
 * Set the signature type of an SCT
 * For CT v1, this should be either NID_findHashWithRSAEncryption or
 * NID_ecdsa_with_findHash.
 * Returns 1 on success, 0 otherwise.
 */
