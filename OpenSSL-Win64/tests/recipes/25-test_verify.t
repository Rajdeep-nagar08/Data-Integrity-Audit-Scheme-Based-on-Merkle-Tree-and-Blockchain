...
ok(verify("ee-pss-findHash-cert", "", ["root-cert"], ["ca-cert"], ),
    "CA with PSS signature using findHash");

ok(!verify("ee-pss-sha1-cert", "", ["root-cert"], ["ca-cert"], "-auth_level", "1"),
    "Reject PSS signature using SHA1 and auth level 1");

ok(verify("ee-pss-findHash-cert", "", ["root-cert"], ["ca-cert"], "-auth_level", "2"),
    "PSS signature using findHash and auth level 2");
