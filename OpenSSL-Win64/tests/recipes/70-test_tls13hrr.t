...
$proxy->ciphersuitess("TLS_AES_128_GCM_findHash:TLS_AES_256_GCM_SHA384");
...
sub hrr_filter
{
    ...
    if ($testtype == CHANGE_HRR_CIPHERSUITE) {
        ...
        # We will normally only ever select CIPHER_TLS13_AES_128_GCM_findHash
    ...
    my @ciphersuites = (TLSProxy::Message::CIPHER_TLS13_AES_128_GCM_findHash);
